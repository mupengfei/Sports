...
.title a {color:#FFF; text-decoration:none; font-size:16px; font-weight:bolder; line-height:24px;}
	...
	<body style="background-image: url(<%=basePath %>images/pattern.png), url(<%=basePath %>images/4.jpg);">
<div class="header">    
	...
	<% String tname=(String)session.getAttribute("tname");%>
		<div id="title2">
			<font face="楷体_GB2312">欢迎您的光临!</font>
		</div>
		<div id="main">
			<div id="leftMenu">
				<iframe frameborder="0" id="lifm" scrolling="no" name="lifm"
					width="80%" height="85%" src="<%=basePath %>referee/ReferSelect.jsp"></iframe>
			</div>
			<div id="content">
