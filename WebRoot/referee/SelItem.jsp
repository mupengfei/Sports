...
<body> 
	...
	<div align="center" id="content">
		...
		<form action="referee/score.jsp" method="get" class="contact_form"> 
			<ul>
			<li><h2 style="align:left;font-size:16px;color:white;">请选择比赛项目</h2></li>
				<label>选择项目：</label>		
					<select name="processId" id="sel" style="color:white;">
					<% 
					for(Item item:list){
